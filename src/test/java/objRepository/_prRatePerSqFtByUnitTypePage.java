...
public class _prRatePerSqFtByUnitTypePage {
	
	public _prRatePerSqFtByUnitTypePage() {
	...
	@FindBy(xpath="//span[contains(text(),'Square Feet by Unit Type')]/ancestor::a")
	protected WebElement $rateByUnitTypeLink;
